<template>
  ...
  <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
    ...
    <h2 class="text-2xl font-semibold text-center mb-4">Visitor Login</h2>
    <p class="text-center mb-4">Sign in to access the visitor portal.</p>
    <form @submit.prevent="handleLogin">
      <div class="mb-4">
        <label for="email-visitor" class="block text-sm font-medium text-gray-700">Email</label>
        <input
          type="email"
          id="email-visitor"
          v-model="form.email"
      ...
      <div class="mb-4">
        <label for="password-visitor" class="block text-sm font-medium text-gray-700">Password</label>
        <input
          type="password"
          id="password-visitor"
      ...
      <div class="mt-4 text-center">
        ...
        <router-link to="/auth/visitorregister" class="text-indigo-600 ml-1 text-sm">Create an account</router-link>
      </div>
    </form>
  </div>
</template>
