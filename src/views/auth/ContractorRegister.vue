...
<!-- 2card contractor  -->
      <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <h2 class="text-2xl font-semibold text-center mb-4">You are New Contractor</h2>
    ...
    <button
      type="submit"
      class="w-full py-2 px-4 bg-yellow-500 text-white font-semibold rounded-lg hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50"
          >
            Sign up
          </button>
        </form>
      ...
      <div class="mt-4 text-center">
        ...
        <router-link to="/auth/contractorlogin" class="text-indigo-600 ml-1 text-sm">Sign in instead</router-link>
      </div> 
      </div>
</template>