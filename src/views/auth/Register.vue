...
<template>
      ...
      <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <h2 class="text-2xl font-semibold text-center mb-4">You are New Admin</h2>
    ...
    <button
      ...
      class="w-full py-2 px-4 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50"
        ...
        <div class="mt-4 text-center">
          ...
          <router-link to="/auth/login" class="text-indigo-600 ml-1 text-sm">Sign in instead</router-link>
        </div> 
      </div>     
</template>
